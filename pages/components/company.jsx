      ...
      <div className="container py-5 m-5">
        ...
        />
          ...
          <div className="lg:text-center py-10">
            ...
            className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded my-2 w-50"
          >
            join us
          </button>
          <ToastContainer />
